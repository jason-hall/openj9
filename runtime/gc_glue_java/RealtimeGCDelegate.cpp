...
MM_RealtimeGCDelegate::allocateAccessBarrier(MM_EnvironmentBase *env)
{
 ...
 */
void
MM_RealtimeGCDelegate::enableDoubleBarrier(MM_EnvironmentBase *env)
{
 ...
 */
void
MM_RealtimeGCDelegate::disableDoubleBarrierOnThread(MM_EnvironmentBase* env, OMR_VMThread* vmThread)
{
 ...
 */
void
MM_RealtimeGCDelegate::disableDoubleBarrier(MM_EnvironmentBase* env)
{
 ...
 */
bool
MM_RealtimeGCDelegate::doClassTracing(MM_EnvironmentRealtime *env)
{
	J9ClassLoader *classLoader;
	bool didWork = false;
...
bool
MM_RealtimeGCDelegate::doTracing(MM_EnvironmentRealtime* env)
{
